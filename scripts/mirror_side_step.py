...
Usage:
  blender --background --python mirror_side_step.py -- <glb_path> <source_anim> <dest_anim>
"""
import bpy, sys

args = sys.argv[sys.argv.index("--") + 1:] if "--" in sys.argv else []
if len(args) < 3:
    print("Usage: blender --background --python mirror_side_step.py -- <glb_path> <source_anim> <dest_anim>")
    sys.exit(1)
